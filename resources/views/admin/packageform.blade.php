            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{url('/admin/packages/update/'.$data->id)}}

                        @else

                        {{url('/admin/packages/store')}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <select class="form-control" required name="ptype">
                                                ...
                                                <option value="Domestic" {{isset($data)&&$data->status=='Domestic'?'selected':''}}>Domestic</option>

                                                <option value="International"{{isset($data)&&$data->status=='International'?'selected':''}}>International</option>
