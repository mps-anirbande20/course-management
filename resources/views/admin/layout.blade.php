...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{asset('admins/assets/css/line-awesome.min.css')}}">
        ...
        <link rel="stylesheet" href="{{asset('admins/assets/css/dataTables.bootstrap4.min.css')}}">
    ...
    <body>
            ...
            <div class="header">
                ...
                <div class="header-left">
                    ...
                    <a href="{{url('/')}}" target="_blank" class="logo">
                        ...
                        <img src="{{asset('admins/assets/img/logo.png')}}" width="40" height="40" alt="">
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <!--li class="submenu">
                                ...
                                <a href="#"><i class="la la-object-group"></i> <span> Manage Blog </span> <span class="menu-arrow"></span></a>

                                <ul style="display: none;">

                                    <li><a href="{{url('/admin/blogcategory')}}">Categories </a></li>
                            ...
                            <li> 
                                ...
                                <a href="{{url('admin/options')}}"><i class="la la-gear"></i> <span>Settings</span></a>

                            </li>

                            <li> 

                                <a href="{{url('admin/logout')}}"><i class="la la-sign-out"></i> <span>Logout</span></a>
        ...
        <script src="{{asset('admins/assets/js/jquery.slimscroll.min.js')}}"></script>
        ...
        <script src="{{asset('admins/assets/js/chart.js')}}"></script>
        ...
        <script src="{{asset('admins/assets/js/dataTables.bootstrap4.min.js')}}"></script>
